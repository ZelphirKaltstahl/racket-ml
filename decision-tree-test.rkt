...
(test-case "select-better-tree test case"
  (let ([tree (Node (list #(1.0 0.10 0)
    ...
    (check-equal? (select-better-tree tree
                                      pruned-tree
                                      pruning-set
                                      feature-column-indices
                                      label-column-index
...
(test-case "prune-with-pruning-set test case"
  (let ([tree (Node (list #(1.0 0.10 0)
                          #(1.1 0.11 0)
                          #(1.2 0.12 0)
                          #(1.3 0.13 0)
        ...
        [pruning-set (list #(1.01 0.101 0)
                           ...
                           #(3.01 0.001 1)
                           #(3.01 0.011 0))])
    (check-equal? (prune-with-pruning-set tree
                                          pruning-set
                                          (list 0 1)
                                          2
                                          #:tolerance 0.06)
